...
class CandidatesConfig(BaseModel):
    ...
    #: Сглаживание чата: зрители реагируют с запозданием в несколько секунд,
    #: поэтому всплеск размазан во времени и по одному окну не виден.
    chat_smooth_seconds: float = 5.0
