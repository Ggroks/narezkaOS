...
class CompilationConfig(BaseModel):
    ...
    **Подборка лучших** — разрозненные пики со всей записи, расставленные по
    ...
    #: Что собирать: story — сюжетный эпизод, best — подборка лучших моментов.
    mode: Literal["story", "best"] = "story"
    ...
    enabled: bool = False
    #: Какой эпизод брать в сюжетном режиме. None — самый цельный из длинных.
